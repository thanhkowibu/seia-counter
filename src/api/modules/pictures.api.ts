...
const pictureEndpoints = {
  list: ({ page }: { page: number }) =>
    `posts.json?page=${page}&tags=seia_%28blue_archive%29+1girl+rating%3Ag%2Cs+parent%3Anone+child%3Anone+limit%3A18`,
  count: `counts/posts.json?page=1&tags=seia_%28blue_archive%29+1girl+rating%3Ag%2Cs+parent%3Anone+child%3Anone+limit%3A18`,
};
